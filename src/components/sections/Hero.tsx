    ...
    <section ref={containerRef} className="relative w-full h-[110vh] bg-black overflow-hidden flex items-center justify-center">
      ...
      <div ref={textRef} className="relative z-10 text-center px-4 pointer-events-none mt-20">
        ...
        <div className="flex justify-center gap-4 pointer-events-auto">
            <a href="https://www.edfringe.com/tickets/whats-on/jamie-leonard-blink-of-an-eye" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 px-10 py-5 bg-white text-black font-bold uppercase tracking-widest text-[10px] md:text-xs hover:bg-gold hover:text-white transition-all duration-300 rounded-full group">
